                ...
                <div id="Cadastro">
                    ...
                    <div >
                        <form onSubmit={handleAddUser} id="InputsCadastro">
                            ...
                            <input type="password" placeholder="Confirmar Senha" value={ConfiSenha} onChange={(e) => setConfSenha(e.target.value)} />
                            <p>já possui uma conta? <Link to="/login">Login</Link></p>
                            <button type="submit" id="BtnLogar" onSubmit={ConfirmarSenha}>Cadastrar</button>
